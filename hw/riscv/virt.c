...
static const MemMapEntry virt_memmap[] = {
    ...
    [VIRT_ACPI_GTMB] =    { 0x10220000, ACPI_GED_MSI_CTRL_LEN * 2},
...
static DeviceState *create_acpi_ged(RISCVVirtState *s)
{
    ...
    if (s->acpi_ged_msimode) {
        /* Index 3 is chosen as ged-regs is initialized before GTMB region */
        sysbus_mmio_map(SYS_BUS_DEVICE(dev), 3, s->memmap[VIRT_ACPI_GTMB].base);
    } else {
